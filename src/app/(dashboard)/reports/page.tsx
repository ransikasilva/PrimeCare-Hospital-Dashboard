    ...
    <div className="space-y-6">
      ...
      {!startDate && !endDate && (
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 flex items-start gap-3">
          ...
          <div>
            <h4 className="font-semibold text-blue-900">Select Date Range to View Report</h4>
            <p className="text-sm text-blue-700">Choose a start and end date above to generate reports</p>
          </div>
        </div>
      )}
